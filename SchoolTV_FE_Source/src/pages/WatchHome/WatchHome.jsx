...
export default function WatchHome() {
  ...
  }, [liveSchedules, upcomingSchedules, videoHistory, posts, loading, upcomingLoading, videoLoading, postsLoading]);
          ...
          <div className="horizontal-scroll-container">
            <div className="events-grid horizontal-scroll">
              {upcomingSchedules.map((schedule) => {
                ...
                const programName = program.programName || "Chương trình không xác định";
                const channelName = program.schoolChannel?.name || "Trường không xác định";
          ...
          <div className="horizontal-scroll-container">
            <div className="videos-grid horizontal-scroll">
              {videoHistory.map((video) => {
                ...
                const programName = video.program?.programName || "Chương trình không xác định";
                const channelName = video.program?.schoolChannel?.name || "Trường không xác định";
