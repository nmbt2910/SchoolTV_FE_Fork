...
import { Layout, Form, Input, Button, message, InputNumber, Typography, Row, Col, Card } from 'antd';
    ...
    <div className='create-package-body'>
      <Layout style={{ minHeight: '100vh' }}>
        ...
        <Layout.Content style={{ padding: '40px' }}>
          <Row justify="center">
            <Col span={24}>
              <Card style={{ maxWidth: '1000px', margin: '0 auto', borderRadius: '16px', padding: '40px', boxShadow: '0 4px 16px rgba(0, 0, 0, 0.05)' }}>
                <Title level={2} style={{ textAlign: 'center', marginBottom: 30 }}>Create Package</Title>
                <Form
                  form={form}
                ...
                >
                  ...
                  <Form.Item
                    ...
                    <Input.TextArea placeholder="Enter package description" rows={3} />
                  </Form.Item>
                  ...
                  <Form.Item
                    ...
                    <InputNumber min={0.01} step={0.01} style={{ width: '100%' }} placeholder="Enter price in USD" />
                  </Form.Item>
                  ...
                  <Form.Item
                    ...
                    name="duration"
                    rules={[
                      { required: true, message: 'Please input package duration!' },
